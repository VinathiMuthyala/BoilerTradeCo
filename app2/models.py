...
class ProductInfo(models.Model):
   ...
   seller_email = models.ForeignKey(User, null=False, on_delete=models.CASCADE)
   name = models.CharField(max_length=100)
   price = models.DecimalField(max_digits=10, decimal_places=2)
   description = models.TextField()
   quality_tag = models.ForeignKey(QualityTag, null=False, on_delete=models.CASCADE)
   category_tag = models.ForeignKey(CategoryTag, null=False, on_delete=models.CASCADE)
